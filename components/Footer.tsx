       ...
       <footer className="footer">
           <section className="footer-container">
                <div className="footer-column">
                    ...
                    <img ref={themeIcon} src={light} onClick={() => changeTheme()} className="footer-img"/>
                </div>
                <div className="footer-column">
                        <h3 className="footer-text">Source Code</h3>
                        <img src={github} onClick={() => window.open("https://github.com/Tenpi/Music-Player", "_blank")} className="footer-img"/>
                </div>
                <div className="footer-column">
                    <img src={hibikiChibi} className="hibiki-chibi"/>
                </div>
           </section>
